<div class="grid grid-cols-1 gap-6 p-4">
    <div class="panel p-5">
        ...
        <div class="mb-5">
            <h1 class="m-4 text-xl font-semibold">ایجاد گارانتی</h1>
    ...
    <div class="panel p-5">
        ...
        <a href="{{route('admin.trashed_guaranties.list')}}" type="button" class="btn btn-danger mb-4 w-[300px]">
                    ...
                    @foreach($this->guaranties as $index => $guaranty)
                        <tr>
                            ...
                            <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                <button wire:click="editRow({{$guaranty->id}})" type="button" x-tooltip="Edit">
                                ...
                                <button
                                    wire:click="$dispatch('delete-guaranty', { guaranty_id: {{ $guaranty->id }} })"
                                    type="button"
                                    x-tooltip="Delete"
                                >
