<div class="grid grid-cols-1 gap-6 p-4">
    <div class="panel p-5">
        ...
        <div class="mb-5">
            <h1 class="m-4 text-xl font-semibold">ایجاد رنگ</h1>
            <form  class="space-y-5">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
                    ...
                    <div>
                        ...
                        <x-color-picker wire:model="code"/>
                    </div>
                    <div>
                        @if($editIndex)
    ...
    <div class="panel p-5">
        ...
        <a href="{{route('admin.trashed_colors.list')}}" type="button" class="btn btn-danger mb-4 w-[300px]">
                    ...
                    @foreach($this->colors as $index => $color)
                        <tr>
                            ...
                            <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                <button wire:click="editRow({{$color->id}})" type="button" x-tooltip="Edit">
                                ...
                                <button
                                    wire:click="$dispatch('delete-color', { color_id: {{ $color->id }} })"
                                    type="button"
                                    x-tooltip="Delete"
                                >
