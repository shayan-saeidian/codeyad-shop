<div class="grid grid-cols-1 gap-6 p-4">
    <div class="panel p-5">
        <a href="{{route('admin.categories.list')}}" type="button" class="btn btn-danger mb-4 w-[300px]">
                ...
                <table>
                    ...
                    @foreach($this->categories as $index => $category)
                        <tr>
                            ...
                            <td class="whitespace-nowrap">{{Verta::instance($category->created_at)->formatJalaliDate()}}</td>
                            <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                <button wire:click="restoreRow({{$category->id}})" type="button" x-tooltip="بازآوری">
                                ...
                                <button
                                    wire:click="$dispatch('hard-delete-category', { category_id: {{ $category->id }} })"
                                    type="button"
                                    x-tooltip="حذف دایم"
                                >
