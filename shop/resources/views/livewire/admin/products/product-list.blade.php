<div class="grid grid-cols-1 gap-6 p-4">
    <div class="panel p-5">
        ...
        <div class="flex">
            <a href="{{route('admin.trashed_products.list')}}" type="button" class="btn btn-danger ml-4 mb-4 mt-4 w-[300px]">
            ...
            <a href="{{route('admin.create.product')}}" type="button" class="btn btn-primary m-4 w-[300px]">
                اضافه کردن محصول
            </a>
        </div>
                ...
                <table>
                    ...
                    @foreach($this->products as $index => $product)
                        <tr>
                            ...
                            <td class="flex items-center justify-center border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
