<div class="grid grid-cols-1 gap-6 p-4">
    <div class="panel p-5">
        <a href="{{route('admin.brands.list')}}" type="button" class="btn btn-danger mb-4 w-[300px]">
                    ...
                    @foreach($this->brands as $index => $brand)
                        <tr>
                            ...
                            <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                <button wire:click="restoreRow({{$brand->id}})" type="button" x-tooltip="بازآوری">
                                ...
                                <button
                                    wire:click="$dispatch('hard-delete-brand', { brand_id: {{ $brand->id }} })"
                                    type="button"
                                    x-tooltip="حذف دایم"
                                >
