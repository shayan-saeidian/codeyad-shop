<div class="grid grid-cols-1 gap-6 p-4">
    <div class="panel p-5">
        ...
        <div class="mb-5">
            <h1 class="m-4 text-xl font-semibold">ایجاد برند</h1>
    ...
    <div class="panel p-5">
        ...
        <a href="{{route('admin.trashed_brands.list')}}" type="button" class="btn btn-danger mb-4 w-[300px]">
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tr>
                        ...
                        <th class="text-center">تاریخ برند</th>
                    ...
                    @foreach($this->brands as $index => $brand)
                        <tr>
                            <td >{{$this->brands->firstItem()+$index}}</td>
                            <td class="whitespace-nowrap flex items-center justify-center">
                                <img src="{{url('images/brands/'.$brand->image)}}" alt="image" class="object-cover w-12 h-12 mb-5 rounded-full">
                            </td>
                            <td class="whitespace-nowrap">{{$brand->name}}</td>
                            <td class="whitespace-nowrap">{{Verta::instance($brand->created_at)->formatJalaliDate()}}</td>
                            <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                <button wire:click="editRow({{$brand->id}})" type="button" x-tooltip="Edit">
